...
@media (max-width: 600px) {
  ...
  .whatsapp-btn:hover { max-width: 64px; }
  ...
  <div class="about-wrapper">
    ...
    <div class="about-photo-col">
      <div class="about-photo-inner">
        ...
        <div class="about-photo-tag">
          <span class="about-tag-num">17</span>
          <span class="about-tag-label">Ans<br>d'expérience</span>
        </div>
    ...
    <div class="about-content-col">
      ...
      <h2 class="about-title">
        Je clarifie<br>ce que les<br>
        <em>frameworks</em><br>ne clarifient jamais.
      </h2>
      ...
      <div class="about-body">
        ...
        <p>J'ai commencé en <strong>marketing</strong>. J'y ai appris à comprendre les personnes, à créer de l'adhésion, à traduire la complexité en clarté. Ces compétences sont devenues le cœur de mon approche de la transformation.</p>
      </div>

      <blockquote class="about-quote">
        « La transformation ne réussit pas grâce aux méthodes seules. Elle réussit quand les acteurs clés savent clairement quelle est leur place — et la place qu'ils veulent construire. »
      </blockquote>
